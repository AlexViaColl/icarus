...
extern "C" {
    ...
    pub fn xcb_get_maxiumm_request_length(c: *mut xcb_connection_t) -> u32;
    ...
    pub fn xcb_poll_for_special_event(c: *mut xcb_connection_t) -> *mut xcb_generic_event_t;
    ...
    pub fn xcb_setup_vendor(s: *const xcb_setup_t) -> *mut i8;
